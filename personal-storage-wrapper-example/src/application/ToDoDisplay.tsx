...
export const ToDoDisplay: React.FC<{
    ...
    return (
        <div className="flex-1 flex flex-col items-center bg-violet-600 overflow-y-scroll px-4">
            <div className="sm:h-1/6 flex-none w-px" />
            <div className="flex-col w-full max-w-[384px] min-w-0">
                <div className="flex w-full sticky pt-5 pb-2 top-0 bg-violet-600">
                    <input
                        className="bg-transparent border rounded-lg text-white focus:outline-violet-500 p-3 placeholder:italic placeholder:text-violet-300 grow outline-none min-w-0"
                ...
                {todos.map(({ id, text }) => (
                    <div key={id} className="rounded-full bg-violet-500 w-full p-1.5 mt-3 flex items-center">
